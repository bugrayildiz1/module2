...
public abstract class TestRunner {
	 ...
	 * 
	 * @param testClass
	 *            The name of the class which is being tested.
	 */
	...
	public void runTests() {
		...
		for (Method method : this.getClass().getMethods()) {
			if (method.isAnnotationPresent(TestMethod.class)) {
				// method.getParameterTypes().length returns the parameter count.
				// Java8 has a nice method.getParameterCount method, but Java7 doesn't.
	 ...
	 * 
	 * @param actual
	 *            The actual value which must equal the expected value.
	 * @param expected
	 *            The expected value.
	 * @param name
	 *            The name of the test.
	 ...
	 * 
	 * @param actual
	 *            The actual value which must not equal the expected value.
	 * @param expected
	 *            The expected value.
	 * @param name
	 *            The name of the test.
