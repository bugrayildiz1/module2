...
/**
 * Main class for Producer/Consumer program illustrating multiple threads modifying a shared object.
 * Illustrates the need for synchronisation and the use of wait and notify This program is based on
 * code provided by Deitel and Deitel <br>
...
/**************************************************************************
 * (C) Copyright 1999 by Deitel & Associates, Inc. and Prentice Hall. * All Rights Reserved. * *
 * DISCLAIMER: The authors and publisher of this book have used their * best efforts in preparing
 * the book. These efforts include the * development, research, and testing of the theories and
 * programs * to determine their effectiveness. The authors and publisher make * no warranty of any
